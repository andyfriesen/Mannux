...
class AnimState {
    ...
    public AnimState(int first, int last, int delay, bool loop) {
        this.first = first;
        this.last = last;
        this.delay = delay;
        this.loop = loop;
    ...
    public static AnimState[] playerwalk = {
		new AnimState(16, 23, 10, true),
		new AnimState(24, 31, 10, true)
	};


    public static AnimState[] playerwalkshootingangleup = {
		new AnimState(48, 55, 10, true),
		new AnimState(56, 63, 10, true)
	};

    public static AnimState[] playerwalkshootingangledown = {
		new AnimState(64, 71, 10, true),
		new AnimState(72, 79, 10, true)
	};

    public static AnimState[] playerwalkshooting = {
		new AnimState(32, 39, 10, true),
		new AnimState(40, 47, 10, true)
	};
    ...
    public static AnimState[] playerjump = {
		new AnimState(82, 85, 8, true),
		new AnimState(90, 93, 8, true)
	};
